...
public static class GameDataInitializationService
{
    ...
    private static GameDataRepositorySet CreateInMemorySet(ContentRepositoryCapabilities capabilities)
    {
        ...
        var systemMem = new InMemorySystemFlagRepository(capabilities);
        var systemFlag = new EditorSystemFlagRepositoryBundle(systemMem, systemMem, systemMem.Capabilities);
    ...
    private static GameDataRepositorySet CreatePostgreSqlSet(EditorPostgreSqlScope scope)
    {
        ...
        var systemRepo = new PostgresSystemFlagRepository(gate);
        var systemFlag = new EditorSystemFlagRepositoryBundle(systemRepo, systemRepo, systemRepo.Capabilities);
