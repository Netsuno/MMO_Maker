...
public sealed class GameDataForm : Form
{
    ...
    /// <summary>Index de la catégorie Système, juste après Compétences.</summary>
    internal const int SystemCategoryIndex = 7;
    ...
    private void BuildPanels(GameDataRepositorySet set)
    {
        ...
        var skillSession = new SpellWorkspaceSession(set.Spell.Repository)
        {
            KindFilter = SpellKind.Skill,
        };
        ...
        _system = new SystemEditorPanel(
            new SystemWorkspaceSession(set.System.Repository),
    ...
    private void ShowCategory()
    {
        ...
        else if (_categoryList.SelectedIndex == SystemCategoryIndex)
        {
