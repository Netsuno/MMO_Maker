...
public sealed class HelpForm : Form
{
    internal const string HelpBody =
        ...
        • Ouvrir Amis épingle la liste à gauche. Elle reste au changement de carte, pendant le déplacement, et pendant la saisie du chat (Entrée / Échap). « Détacher » la laisse se fermer au clic ou à Échap hors saisie. « Épingler » la recolle. « Fermer » la range.
        • Un clic sur un ami (● en ligne, ○ hors ligne) remplit le nom du chuchotement. Entrée envoie seulement si la saisie est déjà ouverte. Échap rend la main au monde.
