...
| **Phase 9** | **NOT READY** (C-fixes landed; CI green on `422993b`; **C2 race pass in flight / awaiting CI**; C-fixes **awaiting re-review**). P9-S **DEFERRED**. Prior READY / gate on tip `5db5f6b` was **withdrawn**. |
...
C2 race pass (kick/ban vs in-flight packet; simultaneous same-account reconnects): **in flight / awaiting CI** on this branch tip. Local Release: Frog.Tests **451** (was 445). Do **not** treat this as gated. Orchestrator owns re-review after CI on the exact tip.
