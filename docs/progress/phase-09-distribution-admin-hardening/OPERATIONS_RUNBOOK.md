...
**Status:** P9-4 start/stop + config overlay (packaged and from-source). Mute/kick/ban are **not** here — P9-1.  
...
There is **no** player-drain command yet (P9-1 / P9-5). Stopping drops TCP sessions. Clients with a reconnect token may come back (12 h lifetime) unless P9-1 later revokes them.
...
- After P9-1 adds sanction tables, restore proofs must be re-run (P9-3 note).
...
No mute/kick/ban opcodes on this tip. When P9-1 lands, grant remains SQL:
