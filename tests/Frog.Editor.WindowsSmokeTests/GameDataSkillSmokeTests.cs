...
public sealed class GameDataSkillSmokeTests
{
    [Fact]
    public void GameData_Skill_CreateSavePublish_InMemory()
    {
        StaTestRunner.Run(() =>
        {
            ...
            try
            {
                ...
                var task = EditorSmokeTestAccess.OpenGameDataAndSaveSampleSkillAsync(window);
