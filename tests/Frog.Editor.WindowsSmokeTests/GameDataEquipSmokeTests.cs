...
public sealed class GameDataEquipSmokeTests
{
    [Fact]
    public void GameData_WeaponAndArmor_CreateSavePublish_InMemory()
    {
        StaTestRunner.Run(() =>
        {
            ...
            try
            {
                ...
                var task = EditorSmokeTestAccess.OpenGameDataAndSaveSampleWeaponAndArmorAsync(window);
