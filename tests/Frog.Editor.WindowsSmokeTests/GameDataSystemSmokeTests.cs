...
public sealed class GameDataSystemSmokeTests
{
    [Fact]
    public void GameData_System_CreateSavePublish_InMemory()
    {
        StaTestRunner.Run(() =>
        {
            ...
            try
            {
                ...
                var task = EditorSmokeTestAccess.OpenGameDataAndSaveSampleSystemAsync(window);
