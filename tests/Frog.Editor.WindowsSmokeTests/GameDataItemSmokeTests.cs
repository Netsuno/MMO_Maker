...
public sealed class GameDataItemSmokeTests
{
    [Fact]
    public void GameData_Item_CreateSavePublish_InMemory()
    {
        StaTestRunner.Run(() =>
        {
            ...
            try
            {
                ...
                var task = EditorSmokeTestAccess.OpenGameDataAndSaveSampleItemAsync(window);
