...
public sealed class GameDataActorSmokeTests
{
    [Fact]
    public void GameData_Actor_CreateSavePublish_InMemory()
    {
        StaTestRunner.Run(() =>
        {
            ...
            try
            {
                ...
                var task = EditorSmokeTestAccess.OpenGameDataAndSaveSampleActorAsync(window);
